...
Download the [self-contained presentation HTML](https://github.com/Harthik777/CN-Project/releases/download/v4.1.0/SentinelUEBA-Offline.html) from the [verified v4.1.0 release](https://github.com/Harthik777/CN-Project/releases/tag/v4.1.0). See [failure behavior, reproduction and limits](docs/DEPENDABILITY.md) and the [public verification record](docs/PUBLIC_DEPLOYMENT.md).
