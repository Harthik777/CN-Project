...
Use “built the detection pipeline” only if that describes your actual contribution. Label synthetic results explicitly, and do not claim real-time deployment or production accuracy.
