...
with httpx.Client(timeout=60, follow_redirects=False) as client:
    ...
    for url in ("https://sentinelueba-harthik.onrender.com/", "https://harthik777.github.io/CN-Project/"):
        ...
        assert all(text in response.text for text in ("From packets to network evidence", "Analyze sample capture", "Upload and analyze", "Export flows CSV", "Browser inference", "Browser only: no upload", "Download offline HTML")), url
